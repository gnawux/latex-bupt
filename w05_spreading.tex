...
本章试图通过对移动个人网络中的系统相关信息与其工作方式的分析，给出一种与其他相关工作相比适用于此种网络的分布式信息存储方式。
...
On the other hand, Huang and Chen  proposed a data replication method considering group mobility in MANET, in which a hierarchical structure is adopted. 
